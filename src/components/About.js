    ...
    return ( 
        <div className="md:my-16 my-8 xl:mx-32  sm:mx-12 mx-6">
            <div className="md:flex">
                <div>
                    <img className="md:rounded-tr-3xl md:rounded-bl-3xl md:rounded-none rounded-xl w-full" src="https://images.unsplash.com/photo-1571805529673-0f56b922b359?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fGNoZWZ8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" />
                </div>
